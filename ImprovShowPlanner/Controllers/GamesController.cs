...
namespace ImprovShowPlanner.Controllers
{
    public class GamesController : Controller
    {
        ...
        public GamesController(ImprovShowContext context)
        {
            _context = context;
        }
        ...
        {
            var improvShowContext = _context.Games.Include(g => g.GameType);
        ...
        public async Task<IActionResult> Create([Bind("GameId,Name,NumPlayers,Desc,GameTypeId")] Models.Game game)
        {
